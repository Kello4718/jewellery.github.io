...
const filterButtons = document.querySelectorAll('.filter__button-container');
const filterArrowDown = document.querySelectorAll('.filter__arrow-down');
const filterArrowUp = document.querySelectorAll('.filter__arrow-up');
